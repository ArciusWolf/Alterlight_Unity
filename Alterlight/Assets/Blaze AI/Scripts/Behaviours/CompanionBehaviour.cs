...
namespace BlazeAISpace
{
    ...
    public class CompanionBehaviour : MonoBehaviour
    {
        ...
        void CheckSkin()
        {
            ...
            int numColliders = Physics.OverlapSphereNonAlloc(transform.position + blaze.vision.visionPosition, blaze.navmeshAgent.radius + 0.1f, hitColliders, layersToAvoid);
