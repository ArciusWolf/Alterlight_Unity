    ...
    {   
        ...
        void OnEnable()
        {
            ...
            if (blaze == null) {
                ...
                if (blaze == null) {
                    Debug.LogWarning("No Blaze AI component found in the game object.");
                    return;
                }
            }
        ...
        {
            Collider[] agentsColl = new Collider[10];
            int agentsCollNum = Physics.OverlapSphereNonAlloc(transform.position + blaze.vision.visionPosition, callOthersRadius, agentsColl, agentLayersToCall);
